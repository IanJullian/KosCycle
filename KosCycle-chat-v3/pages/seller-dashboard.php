    ...
    <div class="container">
        ...
        <div class="dashboard-top seller-dashboard-hero">
            <div>
                ...
                <h1>Dashboard <em>toko kamu.</em></h1>
                <p class="text-muted mb-0">Kelola katalog, stok, pesanan, chat customer, dan riwayat penjualan dari satu tempat.</p>
            </div>
            <div class="d-flex gap-2 flex-wrap">
                <a class="btn btn-primary" href="<?= e(page_url('seller-product-form')) ?>"><i class="bi bi-plus-lg me-1"></i>Tambah produk</a>
                <a class="btn btn-ghost" href="<?= e(page_url('seller-products')) ?>">Kelola katalog</a>
            </div>
        </div>
        ...
        <div class="seller-action-grid">
            ...
            <a class="dashboard-action glass-card" href="<?= e(page_url('chat')) ?>"><i class="bi bi-chat-dots"></i><div><strong>Chat customer</strong><small>Balas pertanyaan dan koordinasi</small></div><i class="bi bi-arrow-right arrow"></i></a>
        ...
        <div class="glass-card p-4 mt-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                <div><span class="eyebrow">Bantuan seller</span><h2 class="h3 mt-1 mb-0">Butuh bantuan admin?</h2></div>
                <a class="btn btn-primary" href="<?= e(page_url('chat', ['new' => 'support'])) ?>"><i class="bi bi-life-preserver me-1"></i>Hubungi admin</a>
            </div>
