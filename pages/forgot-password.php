...
if(is_post()){
    ...
    if(!recaptcha_valid($_POST['g-recaptcha-response'] ?? null, 'forgot_password'))$errors[]='Verifikasi reCAPTCHA belum berhasil.';
    if(!$errors){
