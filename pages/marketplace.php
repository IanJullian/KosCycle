...
<div class="container">
    ...
    <div class="marketplace-hero glass-card">
        ...
        <div class="marketplace-hero-mark" aria-hidden="true"><span></span><i class="bi bi-arrow-repeat"></i></div>
    </div>
    ...
    <div class="marketplace-toolbar glass-card">
        <form method="get" class="catalog-search-form" id="catalog-filter-form">
            ...
            <div class="catalog-filter-row">
                ...
                <a class="catalog-reset <?=$hasFilter?'':'is-disabled'?>" href="<?=e(page_url('marketplace'))?>">
                ...
                <article class="catalog-card glass-card">
                    <a class="catalog-card-media" href="<?=e(page_url('product-detail',['id'=>$p['id']]))?>">
                        <?php if(!empty($p['image_path'])):?>
                            <img
                                src="<?=e(APP_URL.'/'.ltrim((string)$p['image_path'],'/'))?>"
                                alt="<?=e((string)$p['name'])?>"
                                style="object-position:<?=(int)($p['image_crop_x']??50)?>% <?=(int)($p['image_crop_y']??50)?>%"
                            >
                        <?php else:?>
