...
<link href="<?= e(APP_URL) ?>/assets/css/app.css" rel="stylesheet"><link href="<?= e(APP_URL) ?>/assets/css/refinements.css" rel="stylesheet"><link href="<?= e(APP_URL) ?>/assets/css/dashboard-fixes.css" rel="stylesheet">
</head>
<body>
...
<?php if ($role === 'customer'): ?><li class="nav-item"><a class="nav-link" href="<?= e(page_url('orders')) ?>">Pesanan</a></li><?php elseif ($role === 'seller'): ?><li class="nav-item"><a class="nav-link" href="<?= e(page_url('seller-products')) ?>">Produk saya</a></li><li class="nav-item"><a class="nav-link" href="<?= e(page_url('seller-orders')) ?>">Pesanan</a></li><?php else: ?>
